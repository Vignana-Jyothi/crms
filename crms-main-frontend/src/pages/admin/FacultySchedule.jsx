...
export default function FacultySchedule() {
  ...
  useEffect(() => {
    masterDataApi.faculty().then(setFacultyList).catch(() => {});
  }, []);
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <h1 className="font-display text-2xl font-semibold text-navy">Faculty Timetables</h1>
      <p className="mt-1 text-sm text-ink/60">
        Search for lecturers to see their class schedule and availability.
      </p>
