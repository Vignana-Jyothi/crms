...
import { resourcesApi, timetableApi } from '../../api/endpoints';
...
export default function ClassroomSchedule() {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <h1 className="font-display text-2xl font-semibold text-navy">Classroom Timetables</h1>
      <p className="mt-1 text-sm text-ink/60">
        Search for a classroom or lab to see its schedule and availability.
      </p>
